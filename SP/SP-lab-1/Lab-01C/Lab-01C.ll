...
define dso_local i32 @main() #0 {
  ...
  %9 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0BE@MNFHGOON@Type?5the?5number?5x?3?5?$AA@")
  %10 = call i32 (ptr, ...) @scanf(ptr noundef @"??_C@_03DLDNIBIK@?$CFlf?$AA@", ptr noundef %2)
  ...
  %30 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0N@ODIMGOJN@x?$FO2?5?5?$DN?5?$CF?46f?6?$AA@", double noundef %29)
  %31 = load double, ptr %8, align 8
  %32 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0N@MKLHHLBO@x?$FO5?5?5?$DN?5?$CF?46f?6?$AA@", double noundef %31)
  %33 = load double, ptr %7, align 8
  %34 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0N@LPBMJCAN@x?$FO17?5?$DN?5?$CF?46f?6?$AA@", double noundef %33)
  ret i32 0
}
