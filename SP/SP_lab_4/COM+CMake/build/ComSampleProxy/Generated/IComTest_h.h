...
#ifndef __ILPV_FWD_DEFINED__
#define __ILPV_FWD_DEFINED__
typedef interface ILPV ILPV;

#endif 	/* __ILPV_FWD_DEFINED__ */
...
#ifndef __ILPV_INTERFACE_DEFINED__
#define __ILPV_INTERFACE_DEFINED__

/* interface ILPV */
/* [helpstring][version][uuid][object] */ 


EXTERN_C const IID IID_ILPV;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("5DBBB794-81EC-44D8-97BD-C25B949EF887")
    ILPV : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE CalculatePowers( 
            /* [in] */ double x,
            /* [out] */ double *pX2,
            /* [out] */ double *pX5,
            /* [out] */ double *pX17) = 0;
    ...
    typedef struct ILPVVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ILPV, CalculatePowers)
        HRESULT ( STDMETHODCALLTYPE *CalculatePowers )( 
            ILPV * This,
            /* [in] */ double x,
            /* [out] */ double *pX2,
            /* [out] */ double *pX5,
    ...
    interface ILPV
    {
        CONST_VTBL struct ILPVVtbl *lpVtbl;
    };
...
#define ILPV_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ILPV_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ILPV_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ILPV_CalculatePowers(This,x,pX2,pX5,pX17)	\
    ( (This)->lpVtbl -> CalculatePowers(This,x,pX2,pX5,pX17) ) 
...
#endif 	/* __ILPV_INTERFACE_DEFINED__ */
