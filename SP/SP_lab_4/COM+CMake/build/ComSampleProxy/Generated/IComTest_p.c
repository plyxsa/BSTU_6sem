 ...
 */
/* Compiler settings for D:/Uni/SP/SP_lab_4/COM+CMake/ComSampleProxy/IComTest.idl:
...
extern const MIDL_SERVER_INFO ILPV_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ILPV_ProxyInfo;
...
/* 84 */	NdrFcShort( 0x20 ),	/* x86 Stack size/offset = 32 */
/* 86 */	0xc,		/* FC_DOUBLE */
			0x0,		/* 0 */
...
/* 90 */	NdrFcShort( 0x28 ),	/* x86 Stack size/offset = 40 */
/* 92 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* Object interface: ILPV, ver. 1.0,
   GUID={0x5DBBB794,0x81EC,0x44D8,{0x97,0xBD,0xC2,0x5B,0x94,0x9E,0xF8,0x87}} */

#pragma code_seg(".orpc")
static const unsigned short ILPV_FormatStringOffsetTable[] =
    {
    38
    };

static const MIDL_STUBLESS_PROXY_INFO ILPV_ProxyInfo =
    {
    &Object_StubDesc,
    IComTest__MIDL_ProcFormatString.Format,
    &ILPV_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ILPV_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    IComTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _ILPVProxyVtbl = 
{
    &ILPV_ProxyInfo,
    &IID_ILPV,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* ILPV::CalculatePowers */
};

const CInterfaceStubVtbl _ILPVStubVtbl =
{
    &IID_ILPV,
    &ILPV_ServerInfo,
    4,
...
const CInterfaceProxyVtbl * const _IComTest_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_ILPVProxyVtbl,
    0
};
...
const CInterfaceStubVtbl * const _IComTest_StubVtblList[] = 
{
    ...
    ( CInterfaceStubVtbl *) &_ILPVStubVtbl,
    0
};
