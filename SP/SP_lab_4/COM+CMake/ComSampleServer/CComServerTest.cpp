...
class CComServerTest : public IComTest, public ILPV {
public:
  // IUnknown
  ...
  IFACEMETHODIMP QueryInterface(__in REFIID riid, __out void **ppv) {
    ...
    if (SUCCEEDED(hr)) {
      *ppv = nullptr;
      ...
      else if (riid == __uuidof(ILPV)) {
          *ppv = static_cast<ILPV*>(this);
          hr = S_OK;
      }
  ...
  IFACEMETHODIMP CalculatePowers(
      /* [in] */ double x,
      /* [out] */ double* pX2,
      /* [out] */ double* pX5,
      /* [out] */ double* pX17) override
  {
      if (pX2 == nullptr || pX5 == nullptr || pX17 == nullptr)
      {
          return E_POINTER;
      }
