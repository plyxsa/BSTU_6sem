...
CMatrix SphereToCart(CMatrix& PView); // !! Преобразует сферические координаты (r, fi, q), хранящиеся в векторе PView, в декартовы координаты (x, y, z
CMatrix SpaceToWindow(CRectD& rs, CRect& rw); // !! Отображает точки из "мирового" или "видового" прямоугольника rs (с double координатами) в оконный прямоугольник rw
#endif