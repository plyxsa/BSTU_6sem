...
void CMainWnd::OnPaint()
{
	...
	if (Index == 3) {
		...
		camera_pos_s.Format(L"fc=%5.1f,  qc=%5.1f", PView(1), PView(2));
		light_pos_s.Format(L"fl=%5.1f,  ql=%5.1f", PView2(1), PView2(2));
...
void CMainWnd::SetLigthColor()
{
	...
	std::ifstream in("D:\\Uni\\OKG\\OKG_lab9\\lab9\\ligth_color.txt");
...
void CMainWnd::SetCameraPosition()
{
	...
	std::ifstream in("D:\\Uni\\OKG\\OKG_lab9\\lab9\\camera_position.txt");
...
void CMainWnd::SetLigthPosition()
{
	...
	std::ifstream in("D:\\Uni\\OKG\\OKG_lab9\\lab9\\ligth_position.txt");
