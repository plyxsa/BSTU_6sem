...
spool "UNI_MIGRATION_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_UNI_MIGRATION ...
DROP ROLE ROLE_UNI_MIGRATION ;
PROMPT Creating Role ROLE_UNI_MIGRATION ...
CREATE ROLE ROLE_UNI_MIGRATION ;
...
GRANT ALL ON utils TO ROLE_UNI_MIGRATION;
...
GRANT ALL ON ContactInfo TO ROLE_UNI_MIGRATION;
