...
spool "PLUSHFOOD_MIGRATION_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_PLUSHFOOD_MIGRATION ...
DROP ROLE ROLE_PLUSHFOOD_MIGRATION ;
PROMPT Creating Role ROLE_PLUSHFOOD_MIGRATION ...
CREATE ROLE ROLE_PLUSHFOOD_MIGRATION ;

-- PROMPT Drop PlushFood user
-- drop user PlushFood cascade;
   
PROMPT Create user PlushFood
CREATE USER PlushFood IDENTIFIED BY &&PlushFood_password PASSWORD EXPIRE ACCOUNT LOCK /* DEFAULT TABLESPACE USERS  TEMPORARY TABLESPACE TEMP */;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO PlushFood;
...
GRANT ALL ON utils TO ROLE_PLUSHFOOD_MIGRATION;
grant ALL on utils to PlushFood with grant option;

set define on
prompt connecting to PlushFood
...
CREATE TABLE Clients (
  ClientID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  FirstName NVARCHAR2(50) NOT NULL,
  LastName NVARCHAR2(50) NOT NULL,
  UserName NVARCHAR2(50) NOT NULL,
  Email NVARCHAR2(100) NOT NULL,
  PasswordHash NVARCHAR2(256) NOT NULL,
  PhoneNumber NVARCHAR2(15),
  Address NVARCHAR2(255)
);


PROMPT Creating Primary Key Constraint PK__Clients__E67E1A04166A89DF on table Clients ... 
ALTER TABLE Clients
ADD CONSTRAINT PK__Clients__E67E1A04166A89DF PRIMARY KEY
(
  ClientID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Clients__A9D10534F04C5F61 on table Clients
ALTER TABLE Clients
ADD CONSTRAINT UQ__Clients__A9D10534F04C5F61 UNIQUE (
  Email
)
ENABLE
;

GRANT ALL ON Clients TO ROLE_PLUSHFOOD_MIGRATION;
-- DROP TABLE Administrators CASCADE CONSTRAINTS;


PROMPT Creating Table Administrators ...
CREATE TABLE Administrators (
  AdminID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  UserName NVARCHAR2(50) NOT NULL,
  Email NVARCHAR2(100) NOT NULL,
  PasswordHash NVARCHAR2(256) NOT NULL
);
...
PROMPT Creating Primary Key Constraint PK__Administ__719FE4E8BC2DA1A0 on table Administrators ... 
ALTER TABLE Administrators
ADD CONSTRAINT PK__Administ__719FE4E8BC2DA1A0 PRIMARY KEY
(
  AdminID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Administ__A9D1053409E0BBAF on table Administrators
ALTER TABLE Administrators
ADD CONSTRAINT UQ__Administ__A9D1053409E0BBAF UNIQUE (
  Email
)
ENABLE
;

GRANT ALL ON Administrators TO ROLE_PLUSHFOOD_MIGRATION;
-- DROP TABLE MealCategories CASCADE CONSTRAINTS;


PROMPT Creating Table MealCategories ...
CREATE TABLE MealCategories (
  CategoryID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  CategoryName NVARCHAR2(100) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__MealCate__19093A2B089FD967 on table MealCategories ... 
ALTER TABLE MealCategories
ADD CONSTRAINT PK__MealCate__19093A2B089FD967 PRIMARY KEY
(
  CategoryID
)
ENABLE
...
GRANT ALL ON MealCategories TO ROLE_PLUSHFOOD_MIGRATION;
-- DROP TABLE Meals CASCADE CONSTRAINTS;


PROMPT Creating Table Meals ...
CREATE TABLE Meals (
  MealID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  ...
  Proteins NUMBER(10,2) NOT NULL,
  Fats NUMBER(10,2) NOT NULL,
  Carbohydrates NUMBER(10,2) NOT NULL,
  ImagePath NVARCHAR2(255)
);


ALTER TABLE Meals MODIFY (IsAvailable DEFAULT (1));
PROMPT Creating Primary Key Constraint PK__Meals__ACF6A65DB3AFA1AE on table Meals ... 
ALTER TABLE Meals
ADD CONSTRAINT PK__Meals__ACF6A65DB3AFA1AE PRIMARY KEY
(
  MealID
)
ENABLE
...
GRANT ALL ON Meals TO ROLE_PLUSHFOOD_MIGRATION;
-- DROP TABLE Orders CASCADE CONSTRAINTS;


PROMPT Creating Table Orders ...
CREATE TABLE Orders (
  OrderID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
...
PROMPT Creating Primary Key Constraint PK__Orders__C3905BAF5EF7291C on table Orders ... 
ALTER TABLE Orders
ADD CONSTRAINT PK__Orders__C3905BAF5EF7291C PRIMARY KEY
(
  OrderID
)
ENABLE
;
PROMPT Creating Check Constraint CK__Orders__Status__440B1D61 on table Orders... 
ALTER TABLE Orders
ADD CONSTRAINT CK__Orders__Status__440B1D61 CHECK 
(
   ( Status = 'Cancelled'
                  OR Status = 'Delivered'
...
GRANT ALL ON Orders TO ROLE_PLUSHFOOD_MIGRATION;
-- DROP TABLE OrderDetails CASCADE CONSTRAINTS;


PROMPT Creating Table OrderDetails ...
CREATE TABLE OrderDetails (
  OrderDetailID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  OrderID NUMBER(10,0) NOT NULL,
  MealID NUMBER(10,0) NOT NULL,
  Quantity NUMBER(10,0) NOT NULL,
  Price NUMBER(10,2) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__OrderDet__D3B9D30C68EFDD28 on table OrderDetails ... 
ALTER TABLE OrderDetails
ADD CONSTRAINT PK__OrderDet__D3B9D30C68EFDD28 PRIMARY KEY
(
  OrderDetailID
)
ENABLE
;
PROMPT Creating Check Constraint CK__OrderDeta__Quant__47DBAE45 on table OrderDetails... 
ALTER TABLE OrderDetails
ADD CONSTRAINT CK__OrderDeta__Quant__47DBAE45 CHECK 
(
   ( Quantity > (0) )
) 
ENABLE
...
GRANT ALL ON OrderDetails TO ROLE_PLUSHFOOD_MIGRATION;
-- DROP TABLE Returns CASCADE CONSTRAINTS;


PROMPT Creating Table Returns ...
CREATE TABLE Returns (
  ReturnID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  OrderID NUMBER(10,0) NOT NULL,
...
ALTER TABLE Returns MODIFY (ReturnDate DEFAULT SYSDATE);
PROMPT Creating Primary Key Constraint PK__Returns__F445E988E6D6AEA0 on table Returns ... 
ALTER TABLE Returns
ADD CONSTRAINT PK__Returns__F445E988E6D6AEA0 PRIMARY KEY
(
  ReturnID
)
ENABLE
;
PROMPT Creating Check Constraint CK__Returns__Status__4D94879B on table Returns... 
ALTER TABLE Returns
ADD CONSTRAINT CK__Returns__Status__4D94879B CHECK 
(
   ( Status = 'Rejected'
                  OR Status = 'Approved'
                  OR Status = 'Pending' )
...
GRANT ALL ON Returns TO ROLE_PLUSHFOOD_MIGRATION;
...
alter session set current_schema=PlushFood;
set define off
PROMPT Creating Foreign Key Constraint FK_OrderDetails_Orders on table Orders...
ALTER TABLE OrderDetails
ADD CONSTRAINT FK_OrderDetails_Orders FOREIGN KEY
(
  OrderID
)
REFERENCES Orders
...
PROMPT Creating Foreign Key Constraint FK_Meals_MealCategories on table MealCategories...
ALTER TABLE Meals
ADD CONSTRAINT FK_Meals_MealCategories FOREIGN KEY
(
  CategoryID
)
REFERENCES MealCategories
(
  CategoryID
)
ENABLE
...
PROMPT Creating Foreign Key Constraint FK_OrderDetails_Meals on table Meals...
ALTER TABLE OrderDetails
ADD CONSTRAINT FK_OrderDetails_Meals FOREIGN KEY
(
  MealID
)
REFERENCES Meals
...
PROMPT Creating Foreign Key Constraint FK_Returns_Orders on table Orders...
ALTER TABLE Returns
ADD CONSTRAINT FK_Returns_Orders FOREIGN KEY
(
  OrderID
)
REFERENCES Orders
...
PROMPT Creating Foreign Key Constraint FK_Orders_Clients on table Clients...
ALTER TABLE Orders
